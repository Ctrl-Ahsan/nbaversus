        ...
        <div className="premium-container">
            <div className="premium-card">
                <h1 className="premium-title">
                    ...
                    <PiStarFourFill
                        size={"1em"}
                        style={{ marginRight: 10, color: "#facc15" }}
                    />
                    Upgrade to Premium
                </h1>
                ...
                <p className="premium-description">
                    Unlock the full experience. Smarter decisions, less noise.
                </p>

                <p className="premium-pricing">
                    7-day trial for $0 • Then $4.99/month • Cancel anytime
                </p>
